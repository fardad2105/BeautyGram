...
public class CurvedBottomNavigationView extends BottomNavigationView {
    ...
    public CurvedBottomNavigationView(Context context) {
        super(context);
        // CURVE_CIRCLE_RADIUS=(int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 75, context.getResources().getDisplayMetrics());
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        //mFirstCurveStartPoint.set((mNavigationBarWidth / 3) - (CURVE_CIRCLE_RADIUS * 2) - (CURVE_CIRCLE_RADIUS / 1), 0);
        mFirstCurveStartPoint.set((mNavigationBarWidth / 3), 0);
        // the coordinates (x,y) of the end point after curve
        //mFirstCurveEndPoint.set(mNavigationBarWidth / 3, CURVE_CIRCLE_RADIUS + (CURVE_CIRCLE_RADIUS / 4));
        mFirstCurveEndPoint.set(mNavigationBarWidth / 2, mNavigationBarHeight/2);
        // same thing for the second curve
        mSecondCurveStartPoint = mFirstCurveEndPoint;
        //mSecondCurveEndPoint.set((mNavigationBarWidth / 3) + (CURVE_CIRCLE_RADIUS * 2) + (CURVE_CIRCLE_RADIUS / 1), 0);
        mSecondCurveEndPoint.set(2*mNavigationBarWidth / 3, 0);
